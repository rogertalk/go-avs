...
// This test package has been stripped of some obscure cases because multipart2
// is intended to be temporary, and only supports (mostly) compliant formats.
// In addition, quoted-printable support was not implemented.
package multipart2
